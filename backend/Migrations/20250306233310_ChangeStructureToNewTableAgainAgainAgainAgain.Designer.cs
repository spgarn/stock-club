...
namespace club.Migrations
{
    ...
    [Migration("20250306233310_ChangeStructureToNewTableAgainAgainAgainAgain")]
    partial class ChangeStructureToNewTableAgainAgainAgainAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserMeeting1", b =>
                {
                    b.Property<int>("DeclinedMeetingsId")
                        .HasColumnType("integer");

                    b.Property<string>("DeclinersId")
                        .HasColumnType("text");

                    b.HasKey("DeclinedMeetingsId", "DeclinersId");

                    b.HasIndex("DeclinersId");

                    b.ToTable("MeetingDecliners", (string)null);
                });
            ...
            modelBuilder.Entity("ApplicationUserMeeting1", b =>
                {
                    b.HasOne("club.Models.Meeting", null)
                        .WithMany()
                        .HasForeignKey("DeclinedMeetingsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("club.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("DeclinersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
