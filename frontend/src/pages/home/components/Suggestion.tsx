...
export default function Suggestion({ user, suggestion, react, removeSuggestion }: { user: User, suggestion: MeetingSuggestion; react: (meetingId: number, isUpvote: boolean) => void; removeSuggestion: (meetingId: number) => void }) {
