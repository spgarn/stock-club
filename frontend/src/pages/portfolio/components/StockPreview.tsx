...
export default function StockPreview({ data }: IProps) {
    ...
    return <div>
        ...
        <RenderStocks currencies={currencies ?? []} list={list} page={page} rowCount={20} currencyDisplay={"kr"} displayMethod={displayMethod} removeStock={() => console.log("remove")} setEditStock={() => console.log("edit")} setSellPortion={() => console.log("sell")} withLivePrice={false} />
