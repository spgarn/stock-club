export const translate = {
    ...
    "buyPrice": "Inköpsvärde",
    "amount": "Antal",
    "action": "Värde",
    "add_investment": "Lägg till innehav",
    "stock_name": "Tickersymbol",
    "update_cash": "Uppdatera kontanta medel på kontot",
    ...
    "reply": "Svara",
    "no_club": "Du är inte med i en klubb ännu! Be klubbägaren att invita dig. Eller skapa en egen klubb!",
